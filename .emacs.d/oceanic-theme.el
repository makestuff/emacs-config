...
(custom-theme-set-faces
  ...
  '(rtags-errline ((t (:background "red" :foreground "white" :weight bold))))
  '(speedbar-highlight-face ((t (:background "#303030"))))
  ...
  '(compilation-error ((t (:background "red" :foreground "white" :weight bold))))
